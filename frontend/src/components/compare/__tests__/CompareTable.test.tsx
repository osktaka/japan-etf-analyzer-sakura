...
describe('CompareTable', () => {
  it('ETFコードと名前が表示される', () => {
    render(<CompareTable etfs={mockETFs} onRemove={vi.fn()} {...defaultProps} />)
  ...
  it('削除ボタンでonRemoveが呼ばれる', () => {
    ...
    render(<CompareTable etfs={mockETFs} onRemove={handleRemove} {...defaultProps} />)
  ...
  it('最良値がハイライトされる（配当利回り：高い方）', () => {
    render(<CompareTable etfs={mockETFs} onRemove={vi.fn()} highlightBest {...defaultProps} />)
  ...
  it('highlightBest=falseの場合、ハイライトなし', () => {
    render(
      <CompareTable etfs={mockETFs} onRemove={vi.fn()} highlightBest={false} {...defaultProps} />
    )
  ...
  it('ETFが1つの場合、ハイライトなし', () => {
    render(
      <CompareTable etfs={[mockETFs[0]]} onRemove={vi.fn()} highlightBest {...defaultProps} />
    )
  ...
  it('カテゴリがnullの場合は-が表示される', () => {
    ...
    render(<CompareTable etfs={etfNoCategory} onRemove={vi.fn()} {...defaultProps} />)
