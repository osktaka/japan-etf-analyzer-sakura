...
export function MetricTable({ etf, compact = false, showAll = false }: MetricTableProps) {
  const getDeviationType = (rate: number | null): 'positive' | 'negative' | 'neutral' => {
  ...
  const basicMetrics: MetricRow[] = [
    ...
    { label: '配当利回り', value: formatPercent(etf.dividend_yield), highlight: true },
