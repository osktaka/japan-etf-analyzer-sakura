...
10. `20_merge_meeting.md` 末尾の「📋 Phase 3向け洞察エクスポート」セクションを全て読む
...
11. `05_shared_calculations.md` の計算メタデータから「リスクフリーレート」行の出典を確認する
...
12. `timing.json` から各フェーズの実行時間を取得し、合計を算出する
